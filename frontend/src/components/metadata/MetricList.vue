...
import { 
  ...
  BoltIcon, SparklesIcon, MagnifyingGlassIcon, UserIcon, ClockIcon
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 px-2">
      ...
      <div class="flex flex-1 items-center gap-3 w-full md:w-auto">
        <div class="relative flex-1 md:w-64">
          ...
          <input 
            v-model="searchQuery" 
            class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500/20 outline-none text-sm font-medium transition-all" 
