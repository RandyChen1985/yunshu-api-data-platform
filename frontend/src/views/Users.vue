...
const MENU_TREE = [
    ...
    { 
      id: 'menu:playground', label: 'API 调试', 
      children: [] 
    },
    { 
      id: 'menu:users', label: '用户管理', 
      children: [
        { id: 'element:user:manage', label: '管理用户/权限' }
      ] 
    },
    { 
    ...
    { 
      id: 'menu:config', label: '系统设置', 
      children: [
        { id: 'element:config:save', label: '保存系统配置' }
      ] 
    }
]
