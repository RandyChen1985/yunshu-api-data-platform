# 🎉 NanZi API Data Platform v1.0.1 Release Notes

Welcome to **v1.0.1** of NanZi API Data Platform (南孜 · 数据服务平台)! 🚀
...
| **开放集成** | REST `/api/v1` | **+ 南孜 MCP Server**（SSE，系统配置开关） |
...
* 与 [南孜 · 智能体平台](https://github.com/RandyChen1985/nanzi-ai-agent-platform) 形成「Agent 编排 + 数据底座」组合。
...
```bash
# 1. 备份数据库（生产必做）
mysqldump -u... -p... nanzi > backup_pre_1.0.1.sql
...
docker load -i release/nanzi-api_1.0.1_linux-amd64_*.tar
docker tag nanzi-api:1.0.1 nanzi-api:latest
...
部署基础流程与 v1.0.0 相同，详见 [HOW_TO_INSTALL.md](https://github.com/RandyChen1985/nanzi-api-data-platform/blob/main/HOW_TO_INSTALL.md)。
...
```bash
docker load -i nanzi-api_1.0.1_linux-amd64_*.tar
...
完整清单见 [tests/CHECKLIST.md](https://github.com/RandyChen1985/nanzi-api-data-platform/blob/main/tests/CHECKLIST.md)。
...
* 📦 **Source Code (zip)**: `nanzi-api-data-platform-1.0.1.zip`
* 📦 **Source Code (tar.gz)**: `nanzi-api-data-platform-1.0.1.tar.gz`
* 🐳 **Docker Image for Linux amd64 (x86_64)**: `nanzi-api_1.0.1_linux-amd64_*.tar`
* 🐳 **Docker Image for Linux arm64 (aarch64)**: `nanzi-api_1.0.1_linux-arm64_*.tar`
* ⚙️ **Docker Compose YAML file**: `docker-compose.yml`

🔗 **下载地址**: [GitHub Releases v1.0.1](https://github.com/RandyChen1985/nanzi-api-data-platform/releases/tag/1.0.1)
...
| `117c384` | feat(mcp): 落地南孜 MCP Server 与系统配置管理 |
